...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		$res=$con->UpdateStudentPasswordUsingId($studentid,$newpassword,$oldpassword);
		if($res)
		{
			?>
			<script>
		...
		else
		{
	        ...
	        window.location='UpdateStudentPassword.php'
	        </script>
			<?php
		}		
	}
	...
	{
		$passwordErr = "New Password and Confirm Password should be same";
	}
}
?>
<div id="body">
	<div id="content">
        <form method="post" >
            ...
            <tr>
            <th colspan="5">  <a href="Student.php"><img src="back.jpg" alt="back" height="42" width="42"/></a></th>
            </tr>
            ...
            <tr>
            <td><input type="text" name="retypenewpassword" placeholder=" Confirm Password" required="" /></td>
            </tr>
            <tr>
